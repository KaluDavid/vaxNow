      ...
      >
        <div className="flex pt-20 items-center flex-col gap-6">
          ...
          <motion.div
            ...
            whileInView={"visible"}
            viewport={{ once: true }}
            className="flex gap-16 items-center  *:shadow-soft-lg *:flex  *:items-center *:gap-2 *:rounded-sm *:bg-white *:justify-center *:py-5 *:px-[19.5px] *:h-[60px]  font-nunito text-md "
          >
            <motion.span
              variants={child}
              initial="hidden"
