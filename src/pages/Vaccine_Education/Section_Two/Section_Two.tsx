...
export function Section_Two() {
  ...
  return (
    <>
      <motion.div
        {...scaleIn}
        className="flex flex-col text-white bg-blue-600 bg-[url('/assets/Record_keeping/herovirus.png')] items-center bg-cover justify-between w-full lg:px-[100px] sm:px-[50px] px-[20px] text-blue-800 gap-[60px] sm:py-[100px] py-[50px] sm:text-center overflow-x-hidden"
      >
